...
let AddonCompetencyCompetenciesPage = AddonCompetencyCompetenciesPage_1 = class AddonCompetencyCompetenciesPage {
    constructor() {
        ...
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_13__["CoreTime"].once(() => this.performLogView());
        if (!planId) {
    ...
    performLogView() {
        ...
        if (source.USER_ID && source.USER_ID !== _services_sites__WEBPACK_IMPORTED_MODULE_12__["CoreSites"].getCurrentSiteUserId()) {
...
/* harmony import */ var _services_utils_url__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @services/utils/url */ "./src/core/services/utils/url.ts");
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
let AddonCompetencyCompetencyPage = class AddonCompetencyCompetencyPage {
    constructor() {
        ...
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_14__["CoreTime"].once(() => this.performLogView());
        try {
    ...
    performLogView() {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const userId = (_a = source.user) === null || _a === void 0 ? void 0 : _a.id;
            if (source instanceof _addons_competency_classes_competency_plan_competencies_source__WEBPACK_IMPORTED_MODULE_12__["AddonCompetencyPlanCompetenciesSource"]) {
                ...
                yield _services_utils_utils__WEBPACK_IMPORTED_MODULE_8__["CoreUtils"].ignoreErrors(_addons_competency_services_competency__WEBPACK_IMPORTED_MODULE_6__["AddonCompetency"].logCompetencyInPlanView(source.PLAN_ID, compId, this.planStatus, name, userId));
                const wsName = this.planStatus === _addons_competency_services_competency__WEBPACK_IMPORTED_MODULE_6__["AddonCompetencyProvider"].STATUS_COMPLETE
                    ? 'core_competency_user_competency_plan_viewed'
                    : 'core_competency_user_competency_viewed_in_plan';
                _services_analytics__WEBPACK_IMPORTED_MODULE_15__["CoreAnalytics"].logEvent({
                    type: _services_analytics__WEBPACK_IMPORTED_MODULE_15__["CoreAnalyticsEventType"].VIEW_ITEM,
                    ws: wsName,
                    name,
                    data: {
                        id: compId,
                    ...
                    url: _services_utils_url__WEBPACK_IMPORTED_MODULE_16__["CoreUrlUtils"].addParamsToUrl('/admin/tool/lp/user_competency_in_plan.php', {
                        planid: source.PLAN_ID,
                        userid: userId,
                        competencyid: compId,
                    }),
            ...
            yield _services_utils_utils__WEBPACK_IMPORTED_MODULE_8__["CoreUtils"].ignoreErrors(_addons_competency_services_competency__WEBPACK_IMPORTED_MODULE_6__["AddonCompetency"].logCompetencyInCourseView(source.COURSE_ID, compId, name, source.USER_ID));
            _services_analytics__WEBPACK_IMPORTED_MODULE_15__["CoreAnalytics"].logEvent({
                type: _services_analytics__WEBPACK_IMPORTED_MODULE_15__["CoreAnalyticsEventType"].VIEW_ITEM,
                ...
                url: _services_utils_url__WEBPACK_IMPORTED_MODULE_16__["CoreUrlUtils"].addParamsToUrl('/admin/tool/lp/user_competency_in_course.php', {
                    courseid: source.COURSE_ID,
                    competencyid: compId,
                    userid: userId,
                }),
...
let AddonCompetencyCompetencySummaryPage = class AddonCompetencyCompetencySummaryPage {
    constructor() {
        ...
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_7__["CoreTime"].once(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield _services_utils_utils__WEBPACK_IMPORTED_MODULE_5__["CoreUtils"].ignoreErrors(_addons_competency_services_competency__WEBPACK_IMPORTED_MODULE_2__["AddonCompetency"].logCompetencyView(this.competencyId, this.competency.competency.shortname));
...
AddonCompetencyCompetencySummaryPage.ctorParameters = () => [];
