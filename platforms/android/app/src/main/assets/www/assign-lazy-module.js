...
/* harmony import */ var _pages_index__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./pages/index */ "./src/addons/mod/assign/pages/index/index.ts");
/* harmony import */ var _pages_submission_list_submission_list__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./pages/submission-list/submission-list */ "./src/addons/mod/assign/pages/submission-list/submission-list.ts");
...
const commonRoutes = [
    {
        path: ':courseId/:cmId',
        component: _pages_index__WEBPACK_IMPORTED_MODULE_9__["AddonModAssignIndexPage"],
    },
    {
...
const mobileRoutes = [
    ...commonRoutes,
    {
        ...
        component: _pages_submission_list_submission_list__WEBPACK_IMPORTED_MODULE_10__["AddonModAssignSubmissionListPage"],
    },
    {
...
AddonModAssignLazyModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        ...
        declarations: [
            _pages_index__WEBPACK_IMPORTED_MODULE_9__["AddonModAssignIndexPage"],
            _pages_submission_list_submission_list__WEBPACK_IMPORTED_MODULE_10__["AddonModAssignSubmissionListPage"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (":host core-timer.core-timer-under-300 {\n  --timer-background: var(--danger-tint);\n  --timer-text-color: var(--danger-shade);\n}\n:host core-timer.core-timer-under-900 {\n  --timer-background: var(--warning-tint);\n  --timer-text-color: var(--warning-shade);\n}\n/*# sourceMappingURL=data:application/json;base64, */");
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                _services_analytics__WEBPACK_IMPORTED_MODULE_17__["CoreAnalytics"].logEvent({
                    ...
                    name: _singletons__WEBPACK_IMPORTED_MODULE_10__["Translate"].instant('addon.mod_assign.subpagetitle', {
                        contextname: this.assign.name,
                        subpage: _singletons__WEBPACK_IMPORTED_MODULE_10__["Translate"].instant('addon.mod_assign.editsubmission'),
                    }),
...
/***/ "./src/addons/mod/assign/pages/submission-list/submission-list.ts":
/*!************************************************************************!*\
  !*** ./src/addons/mod/assign/pages/submission-list/submission-list.ts ***!
  \************************************************************************/
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                _services_analytics__WEBPACK_IMPORTED_MODULE_13__["CoreAnalytics"].logEvent({
                    type: _services_analytics__WEBPACK_IMPORTED_MODULE_13__["CoreAnalyticsEventType"].VIEW_ITEM_LIST,
                    ws: 'mod_assign_get_submissions',
                    name: _singletons__WEBPACK_IMPORTED_MODULE_8__["Translate"].instant('addon.mod_assign.subpagetitle', {
                        contextname: this.assign.name,
                        subpage: _singletons__WEBPACK_IMPORTED_MODULE_8__["Translate"].instant('addon.mod_assign.grading'),
                    }),
...
let AddonModAssignSubmissionReviewPage = class AddonModAssignSubmissionReviewPage {
    constructor(route) {
        ...
        this.forceLeave = false; // To allow leaving the page without checking for changes.
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_12__["CoreTime"].once(() => {
            if (!this.assign) {
                return;
            }
            ...
            _services_analytics__WEBPACK_IMPORTED_MODULE_13__["CoreAnalytics"].logEvent({
                ...
                name: _singletons__WEBPACK_IMPORTED_MODULE_14__["Translate"].instant('addon.mod_assign.subpagetitle', {
                    contextname: this.assign.name,
                    subpage: _singletons__WEBPACK_IMPORTED_MODULE_14__["Translate"].instant('addon.mod_assign.grading'),
                }),
