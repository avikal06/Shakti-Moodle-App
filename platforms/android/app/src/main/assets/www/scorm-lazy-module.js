...
let AddonModScormPlayerPage = class AddonModScormPlayerPage {
    ...
    logEvent(scoId) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield _services_utils_utils__WEBPACK_IMPORTED_MODULE_8__["CoreUtils"].ignoreErrors(_services_scorm__WEBPACK_IMPORTED_MODULE_12__["AddonModScorm"].logLaunchSco(this.scorm.id, scoId));
