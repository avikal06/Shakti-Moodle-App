...
/* harmony import */ var _pages_courses_courses__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./pages/courses/courses */ "./src/core/features/grades/pages/courses/courses.ts");
...
const mobileRoutes = [
    {
        path: '',
        component: _pages_courses_courses__WEBPACK_IMPORTED_MODULE_8__["CoreGradesCoursesPage"],
    },
    {
        path: ':courseId',
...
CoreGradesCoursesLazyModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [
            _pages_courses_courses__WEBPACK_IMPORTED_MODULE_8__["CoreGradesCoursesPage"],
        ],
    })
...
let CoreGradesCoursesPage = CoreGradesCoursesPage_1 = class CoreGradesCoursesPage {
    ...
    refreshCourses(refresher) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield _services_utils_utils__WEBPACK_IMPORTED_MODULE_10__["CoreUtils"].ignoreErrors(_features_grades_services_grades__WEBPACK_IMPORTED_MODULE_6__["CoreGrades"].invalidateCoursesGradesData());
            yield _services_utils_utils__WEBPACK_IMPORTED_MODULE_10__["CoreUtils"].ignoreErrors(this.courses.reload());
    ...
    fetchInitialCourses() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                _services_utils_dom__WEBPACK_IMPORTED_MODULE_9__["CoreDomUtils"].showErrorModalDefault(error, 'Error loading courses');
            }
        });
    }
};
    ...
    logActivity() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            _services_analytics__WEBPACK_IMPORTED_MODULE_7__["CoreAnalytics"].logEvent({
                ...
                name: _singletons__WEBPACK_IMPORTED_MODULE_11__["Translate"].instant('core.grades.grades'),
                data: { courseId: _services_sites__WEBPACK_IMPORTED_MODULE_8__["CoreSites"].getCurrentSiteHomeId(), category: 'grades' },
