...
/* harmony import */ var _singletons_time__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @singletons/time */ "./src/core/singletons/time.ts");
/* harmony import */ var _services_analytics__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @services/analytics */ "./src/core/services/analytics.ts");
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
let AddonModDataEditPage = class AddonModDataEditPage {
    constructor() {
        ...
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_20__["CoreTime"].once(() => {
            if (!this.database) {
                return;
            }
            _services_analytics__WEBPACK_IMPORTED_MODULE_21__["CoreAnalytics"].logEvent({
                type: _services_analytics__WEBPACK_IMPORTED_MODULE_21__["CoreAnalyticsEventType"].VIEW_ITEM,
    ...
    displayEditFields() {
        ...
        if (template.match(regex)) {
            const unusedFields = this.fieldsArray.filter(field => !template.includes(`[field]="fields[${field.id}]`)).map((field) => `<p><strong>${field.name}</strong></p>` +
...
/* harmony import */ var _singletons_time__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @singletons/time */ "./src/core/singletons/time.ts");
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
let AddonModDataEntryPage = class AddonModDataEntryPage {
    constructor(cdr) {
        ...
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_17__["CoreTime"].once(() => this.performLogView());
    }
    /**
     * @inheritdoc
     */
    ...
    fetchEntryData(refresh = false, isPtr = false) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const actions = _services_data_helper__WEBPACK_IMPORTED_MODULE_14__["AddonModDataHelper"].getActions(this.database, this.access, this.entry, _services_data__WEBPACK_IMPORTED_MODULE_13__["AddonModDataTemplateMode"].SHOW);
    ...
    gotoEntry(offset) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.entryLoaded = false;
            this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_17__["CoreTime"].once(() => this.performLogView()); // Log again after loading data.
            yield this.fetchEntryData();
        });
    }
    /**
    ...
    performLogView() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield _services_utils_utils__WEBPACK_IMPORTED_MODULE_10__["CoreUtils"].ignoreErrors(_services_data__WEBPACK_IMPORTED_MODULE_13__["AddonModData"].logView(this.database.id));
