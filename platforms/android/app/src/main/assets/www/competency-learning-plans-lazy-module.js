...
let AddonCompetencyPlanPage = AddonCompetencyPlanPage_1 = class AddonCompetencyPlanPage {
    constructor() {
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_10__["CoreTime"].once(() => this.performLogView());
        try {
...
let AddonCompetencyPlanListPage = AddonCompetencyPlanListPage_1 = class AddonCompetencyPlanListPage {
    constructor() {
        ...
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_8__["CoreTime"].once(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            var _a;
            const userId = (_a = source.USER_ID) !== null && _a !== void 0 ? _a : _services_sites__WEBPACK_IMPORTED_MODULE_10__["CoreSites"].getCurrentSiteId();
            _services_analytics__WEBPACK_IMPORTED_MODULE_9__["CoreAnalytics"].logEvent({
                type: _services_analytics__WEBPACK_IMPORTED_MODULE_9__["CoreAnalyticsEventType"].VIEW_ITEM_LIST,
                ws: 'tool_lp_data_for_plans_page',
                name: _singletons__WEBPACK_IMPORTED_MODULE_11__["Translate"].instant('addon.competency.userplans'),
                data: { userid: userId },
