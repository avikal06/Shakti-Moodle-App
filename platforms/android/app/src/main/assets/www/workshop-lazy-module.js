...
/* harmony import */ var _singletons_time__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @singletons/time */ "./src/core/singletons/time.ts");
/* harmony import */ var _services_analytics__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @services/analytics */ "./src/core/services/analytics.ts");
...
let AddonModWorkshopAssessmentPage = class AddonModWorkshopAssessmentPage {
    constructor(fb) {
        ...
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_18__["CoreTime"].once(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (!this.workshop) {
                return;
            }
            _services_analytics__WEBPACK_IMPORTED_MODULE_19__["CoreAnalytics"].logEvent({
                type: _services_analytics__WEBPACK_IMPORTED_MODULE_19__["CoreAnalyticsEventType"].VIEW_ITEM,
            ...
            try {
                ...
                if (this.editing) {
                    if (saveOffline) {
                        ...
                        if (!submissionId) {
                            throw new _classes_errors_error__WEBPACK_IMPORTED_MODULE_3__["CoreError"]('Submission cannot be updated without a submissionId');
                        }
                        // Try to send it to server.
