...
let AddonCourseCompletionReportPage = class AddonCourseCompletionReportPage {
    constructor() {
        ...
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_9__["CoreTime"].once(() => {
            _services_analytics__WEBPACK_IMPORTED_MODULE_4__["CoreAnalytics"].logEvent({
                ...
                name: _singletons__WEBPACK_IMPORTED_MODULE_8__["Translate"].instant('addon.coursecompletion.coursecompletion'),
                data: {
    ...
    ngOnInit() {
        try {
            ...
            this.userId = _services_navigator__WEBPACK_IMPORTED_MODULE_5__["CoreNavigator"].getRouteNumberParam('userId') || _services_sites__WEBPACK_IMPORTED_MODULE_6__["CoreSites"].getCurrentSiteUserId();
        }
        catch (error) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                if (error && error.errorcode == 'notenroled') {
                    ...
                    _services_utils_dom__WEBPACK_IMPORTED_MODULE_7__["CoreDomUtils"].showErrorModalDefault(error, 'addon.coursecompletion.couldnotloadreport', true);
                }
            }
        });
    }
...
AddonCourseCompletionReportPage.ctorParameters = () => [];
