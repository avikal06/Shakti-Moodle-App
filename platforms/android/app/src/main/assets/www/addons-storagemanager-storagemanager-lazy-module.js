...
let AddonStorageManagerCourseStoragePage = class AddonStorageManagerCourseStoragePage {
    ...
    ngOnInit() {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.isGuest = (_a = _services_navigator__WEBPACK_IMPORTED_MODULE_7__["CoreNavigator"].getRouteBooleanParam('isGuest')) !== null && _a !== void 0 ? _a : (yield _features_course_services_course_helper__WEBPACK_IMPORTED_MODULE_4__["CoreCourseHelper"].courseUsesGuestAccessInfo(this.courseId)).guestAccess;
    ...
    getCourse(courseId) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                return yield _features_courses_services_courses__WEBPACK_IMPORTED_MODULE_6__["CoreCourses"].getUserCourse(courseId, true);
            }
            catch (_a) {
                // Ignore errors.
            }
            try {
                ...
                return yield _features_courses_services_courses__WEBPACK_IMPORTED_MODULE_6__["CoreCourses"].getCourse(courseId);
            }
            catch (_b) {
                // Ignore errors.
            }
            return yield _features_courses_services_courses__WEBPACK_IMPORTED_MODULE_6__["CoreCourses"].getCourseByField('id', this.courseId);
        });
    }
    /**
    ...
    prefetchCourse(event) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            event.stopPropagation();
            event.preventDefault();
            const course = yield this.getCourse(this.courseId);
            if (!course) {
                _services_utils_dom__WEBPACK_IMPORTED_MODULE_9__["CoreDomUtils"].showErrorModal('core.course.errordownloadingcourse', true);
                return;
            }
            try {
                this.changeDetectorRef.markForCheck();
                ...
                yield Promise.all(this.sections.map(section => this.updateModulesSizes(section.modules, section)));
                this.changeDetectorRef.markForCheck();
            }
            catch (error) {
                if (this.isDestroyed) {
...
let AddonStorageManagerCoursesStoragePage = class AddonStorageManagerCoursesStoragePage {
    ...
    deleteSiteStorage(event) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            event.stopPropagation();
            try {
                const site = _services_sites__WEBPACK_IMPORTED_MODULE_10__["CoreSites"].getRequiredCurrentSite();
