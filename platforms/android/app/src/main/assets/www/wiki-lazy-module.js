...
let AddonModWikiEditPage = class AddonModWikiEditPage {
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const pageTitle = _services_navigator__WEBPACK_IMPORTED_MODULE_5__["CoreNavigator"].getRouteParam('pageTitle');
            this.originalTitle = pageTitle ? _services_utils_text__WEBPACK_IMPORTED_MODULE_9__["CoreTextUtils"].cleanTags(pageTitle.replace(/\+/g, ' '), { singleLine: true }) : '';
            this.canEditTitle = !this.originalTitle;
            this.title = this.originalTitle ?
                _singletons__WEBPACK_IMPORTED_MODULE_11__["Translate"].instant('addon.mod_wiki.editingpage', { $a: this.originalTitle }) :
    ...
    fetchWikiPageData() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const syncResult = this.blockId ? yield _services_wiki_sync__WEBPACK_IMPORTED_MODULE_16__["AddonModWikiSync"].waitForSync(this.blockId) : undefined;
                if (this.pageId) {
    ...
    logView() {
        ...
        if (this.pageId) {
            ...
            if (this.subwikiId) {
                ...
                url = `/mod/wiki/create.php?wid=${this.wikiId}&group=${(_a = this.groupId) !== null && _a !== void 0 ? _a : 0}&uid=${(_b = this.userId) !== null && _b !== void 0 ? _b : 0}&title=${title}`;
            }
        }
        else {
        ...
        _services_analytics__WEBPACK_IMPORTED_MODULE_17__["CoreAnalytics"].logEvent({
            ...
            name: (_c = this.originalTitle) !== null && _c !== void 0 ? _c : _singletons__WEBPACK_IMPORTED_MODULE_11__["Translate"].instant('addon.mod_wiki.newpagehdr'),
