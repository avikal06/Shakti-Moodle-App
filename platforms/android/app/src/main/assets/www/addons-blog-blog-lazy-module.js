...
/* harmony import */ var _services_analytics__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @services/analytics */ "./src/core/services/analytics.ts");
...
/* harmony import */ var _services_utils_url__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @services/utils/url */ "./src/core/services/utils/url.ts");
...
/* harmony import */ var _singletons_time__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @singletons/time */ "./src/core/singletons/time.ts");
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
let AddonBlogEntriesPage = class AddonBlogEntriesPage {
    constructor() {
        ...
        this.currentUserId = _services_sites__WEBPACK_IMPORTED_MODULE_9__["CoreSites"].getCurrentSiteUserId();
        this.siteHomeId = _services_sites__WEBPACK_IMPORTED_MODULE_9__["CoreSites"].getCurrentSiteHomeId();
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_14__["CoreTime"].once(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield _services_utils_utils__WEBPACK_IMPORTED_MODULE_13__["CoreUtils"].ignoreErrors(_addons_blog_services_blog__WEBPACK_IMPORTED_MODULE_1__["AddonBlog"].logView(this.filter));
            _services_analytics__WEBPACK_IMPORTED_MODULE_7__["CoreAnalytics"].logEvent({
                type: _services_analytics__WEBPACK_IMPORTED_MODULE_7__["CoreAnalyticsEventType"].VIEW_ITEM_LIST,
                ws: 'core_blog_view_entries',
                name: this.title,
                data: Object.assign(Object.assign({}, this.filter), { category: 'blog' }),
                url: _services_utils_url__WEBPACK_IMPORTED_MODULE_12__["CoreUrlUtils"].addParamsToUrl('/blog/index.php', Object.assign(Object.assign({}, this.filter), { modid: this.filter.cmid, cmid: undefined })),
            });
        }));
    }
    /**
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const userId = _services_navigator__WEBPACK_IMPORTED_MODULE_8__["CoreNavigator"].getRouteNumberParam('userId');
            const courseId = _services_navigator__WEBPACK_IMPORTED_MODULE_8__["CoreNavigator"].getRouteNumberParam('courseId');
            const cmId = _services_navigator__WEBPACK_IMPORTED_MODULE_8__["CoreNavigator"].getRouteNumberParam('cmId');
            const entryId = _services_navigator__WEBPACK_IMPORTED_MODULE_8__["CoreNavigator"].getRouteNumberParam('entryId');
            const groupId = _services_navigator__WEBPACK_IMPORTED_MODULE_8__["CoreNavigator"].getRouteNumberParam('groupId');
            const tagId = _services_navigator__WEBPACK_IMPORTED_MODULE_8__["CoreNavigator"].getRouteNumberParam('tagId');
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const promises = result.entries.map((entry) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                    ...
                    entry.summary = _services_utils_text__WEBPACK_IMPORTED_MODULE_11__["CoreTextUtils"].replacePluginfileUrls(entry.summary, entry.summaryfiles || []);
                    entry.user = yield _services_utils_utils__WEBPACK_IMPORTED_MODULE_13__["CoreUtils"].ignoreErrors(_features_user_services_user__WEBPACK_IMPORTED_MODULE_6__["CoreUser"].getProfile(entry.userid, entry.courseid, true));
                }));
                if (refresh) {
                    this.entries = result.entries;
                }
                else {
                    this.entries = _services_utils_utils__WEBPACK_IMPORTED_MODULE_13__["CoreUtils"].uniqueArray(this.entries
                ...
                _services_utils_dom__WEBPACK_IMPORTED_MODULE_10__["CoreDomUtils"].showErrorModalDefault(error, 'addon.blog.errorloadentries', true);
    ...
    refresh(refresher) {
        ...
        _services_utils_utils__WEBPACK_IMPORTED_MODULE_13__["CoreUtils"].allPromises(promises).finally(() => {
