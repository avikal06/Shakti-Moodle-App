...
let AddonCompetencyCourseCompetenciesPage = AddonCompetencyCourseCompetenciesPage_1 = class AddonCompetencyCourseCompetenciesPage {
    constructor() {
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_8__["CoreTime"].once(() => this.performLogView());
        try {
    ...
    openCompetencySummary(competencyId) {
        _services_navigator__WEBPACK_IMPORTED_MODULE_2__["CoreNavigator"].navigate(`./${competencyId}/${_addons_competency_competency_module__WEBPACK_IMPORTED_MODULE_4__["ADDON_COMPETENCY_SUMMARY_PAGE"]}`, {
            params: {
    ...
    performLogView() {
        ...
        if (source.USER_ID && source.USER_ID !== _services_sites__WEBPACK_IMPORTED_MODULE_10__["CoreSites"].getCurrentSiteUserId()) {
        ...
        _services_analytics__WEBPACK_IMPORTED_MODULE_9__["CoreAnalytics"].logEvent({
            ...
            name: _singletons__WEBPACK_IMPORTED_MODULE_11__["Translate"].instant('addon.competency.coursecompetencies'),
            data: {
                category: 'competency',
