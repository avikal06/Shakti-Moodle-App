...
/* harmony import */ var _pages_index__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pages/index */ "./src/addons/mod/forum/pages/index/index.ts");
...
const mobileRoutes = [
    {
        path: ':courseId/:cmId',
        component: _pages_index__WEBPACK_IMPORTED_MODULE_7__["AddonModForumIndexPage"],
    },
    {
        path: ':courseId/:cmId/new/:timeCreated',
        loadChildren: () => Promise.all(/*! import() | forum-new-discussion-lazy-module */[__webpack_require__.e("common"), __webpack_require__.e("forum-new-discussion-lazy-module")]).then(__webpack_require__.bind(null, /*! ./forum-new-discussion-lazy.module */ "./src/addons/mod/forum/forum-new-discussion-lazy.module.ts")).then(m => m.AddonForumNewDiscussionLazyModule),
    },
    {
        path: ':courseId/:cmId/:discussionId',
        loadChildren: () => Promise.all(/*! import() | forum-discussion-lazy-module */[__webpack_require__.e("common"), __webpack_require__.e("forum-discussion-lazy-module")]).then(__webpack_require__.bind(null, /*! ./forum-discussion-lazy.module */ "./src/addons/mod/forum/forum-discussion-lazy.module.ts")).then(m => m.AddonForumDiscussionLazyModule),
    },
    {
...
AddonModForumLazyModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [
            _pages_index__WEBPACK_IMPORTED_MODULE_7__["AddonModForumIndexPage"],
        ],
    })
...
/* harmony import */ var _components_index_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/index/index */ "./src/addons/mod/forum/components/index/index.ts");
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
AddonModForumIndexPage.propDecorators = {
    activityComponent: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: [_components_index_index__WEBPACK_IMPORTED_MODULE_3__["AddonModForumIndexComponent"],] }]
};
