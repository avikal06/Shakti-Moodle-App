(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-profile-lazy-module"],{
...
/***/ "./src/core/features/user/pages/profile/profile.ts":
/*!*********************************************************!*\
  !*** ./src/core/features/user/pages/profile/profile.ts ***!
  \*********************************************************/
...
let CoreUserProfilePage = class CoreUserProfilePage {
    constructor(route) {
        ...
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_15__["CoreTime"].once((user) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                yield _features_user_services_user__WEBPACK_IMPORTED_MODULE_6__["CoreUser"].logView(this.userId, this.courseId, user.fullname);
            }
            catch (error) {
            ...
            let extraParams = '';
            if (this.userId !== _services_sites__WEBPACK_IMPORTED_MODULE_3__["CoreSites"].getCurrentSiteUserId()) {
                const isCourseProfile = this.courseId && this.courseId !== _services_sites__WEBPACK_IMPORTED_MODULE_3__["CoreSites"].getCurrentSiteHomeId();
            ...
            _services_analytics__WEBPACK_IMPORTED_MODULE_16__["CoreAnalytics"].logEvent({
                ...
                name: user.fullname + ': ' + _singletons__WEBPACK_IMPORTED_MODULE_17__["Translate"].instant('core.publicprofile'),
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (this.courseId && this.user && 'groups' in this.user) {
                    const separator = _singletons__WEBPACK_IMPORTED_MODULE_17__["Translate"].instant('core.listsep');
                    this.userGroups = (_a = this.user.groups) === null || _a === void 0 ? void 0 : _a.map(group => group.name).join(separator + ' ');
                }
            }
            finally {
...
/***/ "./src/core/features/user/user-profile-lazy.module.ts":
/*!************************************************************!*\
  !*** ./src/core/features/user/user-profile-lazy.module.ts ***!
  \************************************************************/
/*! exports provided: CoreUserProfileLazyModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CoreUserProfileLazyModule", function() { return CoreUserProfileLazyModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _core_shared_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/core/shared.module */ "./src/core/shared.module.ts");
/* harmony import */ var _features_user_pages_profile_profile__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @features/user/pages/profile/profile */ "./src/core/features/user/pages/profile/profile.ts");
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
const routes = [
    {
        path: '',
        component: _features_user_pages_profile_profile__WEBPACK_IMPORTED_MODULE_4__["CoreUserProfilePage"],
    },
];
let CoreUserProfileLazyModule = class CoreUserProfileLazyModule {
};
CoreUserProfileLazyModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [
            _features_user_pages_profile_profile__WEBPACK_IMPORTED_MODULE_4__["CoreUserProfilePage"],
        ],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]],
    })
], CoreUserProfileLazyModule);
...
//# sourceMappingURL=user-profile-lazy-module.js.map