...
/* harmony import */ var _pages_list_list__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/list/list */ "./src/addons/notes/pages/list/list.ts");
...
const routes = [
    {
        path: '',
        component: _pages_list_list__WEBPACK_IMPORTED_MODULE_6__["AddonNotesListPage"],
    },
];
...
AddonNotesLazyModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        declarations: [
            _pages_list_list__WEBPACK_IMPORTED_MODULE_6__["AddonNotesListPage"],
        ],
    })
...
/***/ "./src/addons/notes/pages/list/list.ts":
/*!*********************************************!*\
  !*** ./src/addons/notes/pages/list/list.ts ***!
  \*********************************************/
...
/* harmony import */ var _services_analytics__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @services/analytics */ "./src/core/services/analytics.ts");
...
let AddonNotesListPage = class AddonNotesListPage {
    constructor() {
        ...
        this.logView = _singletons_time__WEBPACK_IMPORTED_MODULE_19__["CoreTime"].once(() => this.performLogView());
        try {
            this.courseId = _services_navigator__WEBPACK_IMPORTED_MODULE_11__["CoreNavigator"].getRequiredRouteNumberParam('courseId');
            this.userId = _services_navigator__WEBPACK_IMPORTED_MODULE_11__["CoreNavigator"].getRouteNumberParam('userId');
        }
        catch (error) {
        ...
        this.syncObserver = _singletons_events__WEBPACK_IMPORTED_MODULE_18__["CoreEvents"].on(_addons_notes_services_notes_sync__WEBPACK_IMPORTED_MODULE_5__["AddonNotesSyncProvider"].AUTO_SYNCED, (data) => {
            var _a;
        ...
        }, _services_sites__WEBPACK_IMPORTED_MODULE_12__["CoreSites"].getCurrentSiteId());
        this.currentUserId = _services_sites__WEBPACK_IMPORTED_MODULE_12__["CoreSites"].getCurrentSiteUserId();
    }
    /**
     * @inheritdoc
     */
    ...
    fetchNotes(sync = false, showSyncErrors = false) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (sync) {
                yield this.syncNotes(showSyncErrors);
            }
            try {
                ...
                notesList.forEach((note) => {
                    note.content = _services_utils_text__WEBPACK_IMPORTED_MODULE_14__["CoreTextUtils"].decodeHTML(note.content);
                });
    ...
    addNote(e) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            e.stopPropagation();
            this.logViewAdd();
            const modalData = yield _services_utils_dom__WEBPACK_IMPORTED_MODULE_13__["CoreDomUtils"].openModal({
    ...
    deleteNote(e, note) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield _services_utils_dom__WEBPACK_IMPORTED_MODULE_13__["CoreDomUtils"].showDeleteConfirm('addon.notes.deleteconfirm');
                try {
                    yield _addons_notes_services_notes__WEBPACK_IMPORTED_MODULE_3__["AddonNotes"].deleteNote(note, this.courseId);
                    this.showDelete = false;
                    this.refreshNotes(false);
                    _services_utils_dom__WEBPACK_IMPORTED_MODULE_13__["CoreDomUtils"].showToast('addon.notes.eventnotedeleted', true, _services_utils_dom__WEBPACK_IMPORTED_MODULE_13__["ToastDuration"].LONG);
                }
                catch (error) {
                    _services_utils_dom__WEBPACK_IMPORTED_MODULE_13__["CoreDomUtils"].showErrorModalDefault(error, 'Delete note failed.');
                }
            }
            catch (_a) {
    ...
    showSyncWarnings(warnings) {
        ...
        if (message) {
            _services_utils_dom__WEBPACK_IMPORTED_MODULE_13__["CoreDomUtils"].showAlert(undefined, message);
        }
    }
    /**
     * Log view.
    ...
    performLogView() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield _services_utils_utils__WEBPACK_IMPORTED_MODULE_16__["CoreUtils"].ignoreErrors(_addons_notes_services_notes__WEBPACK_IMPORTED_MODULE_3__["AddonNotes"].logView(this.courseId, this.userId));
            _services_analytics__WEBPACK_IMPORTED_MODULE_10__["CoreAnalytics"].logEvent({
                type: _services_analytics__WEBPACK_IMPORTED_MODULE_10__["CoreAnalyticsEventType"].VIEW_ITEM_LIST,
                ws: 'core_notes_view_notes',
                name: _singletons__WEBPACK_IMPORTED_MODULE_17__["Translate"].instant('addon.notes.notes'),
                data: { courseid: this.courseId, userid: this.userId || 0, category: 'notes' },
                url: _services_utils_url__WEBPACK_IMPORTED_MODULE_15__["CoreUrlUtils"].addParamsToUrl('/notes/index.php', {
                    user: this.userId,
                    course: this.courseId !== _services_sites__WEBPACK_IMPORTED_MODULE_12__["CoreSites"].getCurrentSiteHomeId() ? this.courseId : undefined,
                }),
            });
        });
    }
    ...
    logViewAdd() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            _services_analytics__WEBPACK_IMPORTED_MODULE_10__["CoreAnalytics"].logEvent({
                type: _services_analytics__WEBPACK_IMPORTED_MODULE_10__["CoreAnalyticsEventType"].VIEW_ITEM,
                ws: 'core_notes_create_notes',
                name: _singletons__WEBPACK_IMPORTED_MODULE_17__["Translate"].instant('addon.notes.notes'),
                data: { courseid: this.courseId, userid: this.userId || 0, category: 'notes' },
                url: _services_utils_url__WEBPACK_IMPORTED_MODULE_15__["CoreUrlUtils"].addParamsToUrl('/notes/edit.php', {
                    courseid: this.courseId,
                    userid: this.userId,
